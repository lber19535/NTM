========================================================================
    ACTIVE TEMPLATE LIBRARY : FFMPEGInterop Project Overview
========================================================================

AppWizard has created this FFMPEGInterop project for you to use as the starting point for
...
FFMPEGInterop.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (FFMPEGInterop.h)
        GUID definitions                                (FFMPEGInterop_i.c)
        A type library                                  (FFMPEGInterop.tlb)
        Marshaling code                                 (FFMPEGInterop_p.c and dlldata.c)

FFMPEGInterop.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in FFMPEGInterop.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named FFMPEGInterop.pch and a precompiled types file named StdAfx.obj.
...
FFMPEGInteropps.vcxproj
	...
	dlldata.c, FFMPEGInterop_i.c and FFMPEGInterop_p.c which are required
	to build the proxy/stub DLL.

FFMPEGInteropps.vcxproj.filters
